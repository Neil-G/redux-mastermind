...
exports.default = function (_ref) {
	...
	var store = void 0;
	var createStore = options.createStore || createStore;
	var middlewares = options.middlewares || [];
	var reducers = options.reducers || {};
	if (options.test == true) {

		// for tests
		store = createStore((0, _redux.combineReducers)(Object.assign({}, (0, _configureReducers2.default)(initialStoreState), reducers)), _redux.applyMiddleware.apply(undefined, _toConsumableArray(middlewares)));
	} else if (options.web || options.web == undefined) {

		// for web projects
		store = createStore((0, _redux.combineReducers)(Object.assign({}, (0, _configureReducers2.default)(initialStoreState), reducers)), window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__(), _redux.applyMiddleware.apply(undefined, [].concat(_toConsumableArray(middlewares), [_reduxLogger2.default])));
	} else {

		// for mobile
		store = createStore((0, _redux.combineReducers)(Object.assign({}, (0, _configureReducers2.default)(initialStoreState), reducers)), _redux.applyMiddleware.apply(undefined, [].concat(_toConsumableArray(middlewares), [_reduxLogger2.default])));
	}
