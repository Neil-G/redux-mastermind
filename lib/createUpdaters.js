...
exports.default = function (_ref) {
	...
	return {
		...
		firestore: !firebase ? undefined : function (instructions) {
			...
			var docId = serviceOptions.docId,
			    collectionRefName = serviceOptions.collectionRefName,
			...
			return firebase.firestoreRefs[refGeneratorName](refGeneratorConfig)[methodName](args).then(function (res) {
		...
		basicFirebase: !firebase ? undefined : function (_ref2) {
